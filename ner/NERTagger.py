...
class NERTaggedText(object):
    ...
    def __init__(self, text, tagged_seg_list):
        ...
        self.valid_tag_set = set(['Ns', 'nz', 'Nh', 'Ni', 'nt', 'v', 'm', 'q'])
        self.tag_entity_dict = {'Ns':'geo','nz': 'ohterN', 'Nh':'person','Ni':'org','nt':'date','m':'num','mp':'percent'}
...
class NERTagger(object):
    ...
    def __init__(self, model_dir_path, com_blacklist):
        ...
        with open(com_blacklist,encoding='UTF-8') as f_com_blacklist:
...
if __name__ == "__main__":
    ...
    text = '楚天视讯有线电视网络资产及负债'

    ner_tagger = NERTagger("d:/ltp_data_v3.4.0","config/ner_com_blacklist.txt")
